          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col justify-start space-x-3">
                <h3 className="text-xl text-red-600 font-bold p-1">Contacts</h3>
                <p>
                  <span>
                    <i className="fa-solid text-red-600 fa-phone"></i>
                  </span>
                  <span className="ml-1">01700-000001</span>
                </p>
                <p>
                  <span>
                    <i className="fa-solid text-red-600 fa-envelope"></i>
                  </span>
